...
const generarPrincipal = () =>{
    ...
    `<div id="blur"> 
        ...
        <section class="middle">
            <aside>
                <section class="molde-aside"><button class="botones-laterales" id="btn1"  onclick="hacerClick(1)">EMPRESAS</button></section><form action="/Segunda Entrega/Admin/aggempresa.html"><input value="Agregar Empresas" type="submit"id="submit" ></form>
                <section class="molde-aside"><button class="botones-laterales" id="btn2" onclick="hacerClick(2)">MOTORISTA</button></section><form action="/Segunda Entrega/Admin/aggmotorista.html"><input value="Agregar Motorista" type="submit"id="submit" ></form>
                <section class="molde-aside"><button class="botones-laterales" id="btn3" onclick="hacerClick(3)">ORDENES</button></section><form action="/Segunda Entrega/Admin/aggordenes.html"><input value="Agregar Orden" type="submit"id="submit" ></form>
                <section class="molde-aside"><button class="botones-laterales" id="btn4" onclick="hacerClick(4)">PRODUCTOS</button></section><form action="/Segunda Entrega/Admin/aggItems.html"><input value="Agregar Productos" type="submit"id="submit" ></form>
            </aside>
